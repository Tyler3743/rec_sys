set -gx CONDA_EXE (cygpath "D:/rec_sys/.vscode\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "D:/rec_sys/.vscode")
set _CONDA_EXE (cygpath "D:/rec_sys/.vscode\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "D:/rec_sys/.vscode\python.exe")
