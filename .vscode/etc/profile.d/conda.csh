setenv CONDA_EXE `cygpath D:/rec_sys/.vscode\Scripts\conda.exe`
setenv _CONDA_ROOT `cygpath D:/rec_sys/.vscode`
setenv _CONDA_EXE `cygpath D:/rec_sys/.vscode\Scripts\conda.exe`
setenv CONDA_PYTHON_EXE `cygpath D:/rec_sys/.vscode\python.exe`
